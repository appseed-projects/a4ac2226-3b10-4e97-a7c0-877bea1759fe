...
- Timestamp: `2022-05-11 12:02`
- Build ID: `a4ac2226-3b10-4e97-a7c0-877bea1759fe`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a4ac2226-3b10-4e97-a7c0-877bea1759fe.git
$ cd a4ac2226-3b10-4e97-a7c0-877bea1759fe
```
